...
export const myProjects = [
    {
        title: 'FoodBuddy App - A Food Ordering App',
        desc: 'A meal tracking and recommendation Android app built with Kotlin. It provides persistent cart, login, and location-specific meal suggestions while supporting light and dark themes.',
        subdesc:
            'Implemented using MVVM, RecyclerView, SharedPreferences, and Material Design, this app enhanced user retention and onboarding experience during testing sessions.',
        href: 'https://github.com/Aerospace-prog/Food-Buddy',
        texture: '/textures/project/project1.mp4',
        logo: '/assets/project-logo1.png',
        logoStyle: {
            backgroundColor: '#2A1816',
    ...
    {
        title: 'HealthSetu - Online Appointment Booking Platform',
    ...
    {
        title: 'SpotLight App - Social Media App',
        desc: 'A real-time social media app built with React Native and Expo. It includes posts, profiles, follows, notifications, and a clean scalable structure.',
        subdesc:
            'Integrated with Convex backend and Clerk authentication, SpotLight ensures secure login flows, polished UI components, and responsive layouts.',
        href: 'https://github.com/Aerospace-prog/SpotLight-App',
        texture: '/textures/project/project3.mp4',
        logo: '/assets/project-logo3.png',
        logoStyle: {
            backgroundColor: '#60f5a1',
